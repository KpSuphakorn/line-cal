...
WELCOME_FEATURES_TEXT = (
    ...
    "กินหลายอย่าง คั่นด้วย + เช่น กิน ข้าวมันไก่ + น้ำส้ม + สลัดจานเล็ก\n\n"
...
def handle_text_message(event: MessageEvent, user_id: str, messaging_api: MessagingApi, db: Session):
    ...
    if text in {"สวัสดี", "หวัดดี", "hello", "hi"}:
        reply_text(messaging_api, event.reply_token, "สวัสดีครับ พิมพ์ กิน ตามด้วยชื่ออาหาร (หลายอย่างคั่นด้วย +) หรือพิมพ์ วิธีใช้ เพื่อดูคำสั่ง")
        return
