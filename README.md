...
ข้อความอื่นที่ไม่ตรงกับคำสั่งใด ๆ (รวมถึงคำทักทาย) จะได้การ์ด `วิธีใช้` กลับไปเสมอ

คำสั่งที่เปิดหน้าเว็บ (`ประวัติ`, `โปรไฟล์`) ตอบกลับเป็นการ์ดที่มีปุ่มเปิดในตัว กดครั้งเดียวเข้า Web App ได้เลย
